...
namespace ROLib
{
    public class ModuleROLAirstreamShield : PartModule, IAirstreamShield
    {
    ...
    public class AirstreamShieldArea
    {
        ...
        {
            ModuleROLAirstreamShield.findShieldedPartsCylinder(p, shieldedParts, topY, bottomY, topRadius, bottomRadius);
        }
