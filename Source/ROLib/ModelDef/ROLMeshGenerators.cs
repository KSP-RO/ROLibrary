...
namespace ROLib
{
    ...
    public class ROLCylinderMeshGenerator
    {
        ...
        public ROLCylinderMeshGenerator(Vector3 offset, int faces, float height, float bottomRadius, float topRadius, float bottomInnerRadius, float topInnerRadius)
        {
            this.offset = offset;
            this.faces = faces;
            this.height = height;
        ...
        **/
        ...
        public GameObject[] generatePanels(Transform parent, Vector3 pivot)
        {
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                GameObject pivotObject = parent.ROLFindOrCreate("FairingPanelPivot-"+i).gameObject;
    ...
    public class Arc
    {
        ...
        public List<Vertex> generateVertices(ROLMeshBuilder builder, Vector3 offset, UVArea area, float v, float yCos, float ySin)
        {
    ...
    public class PanelArcGroup
    {
        ...
        private void generatePanelSegment(ROLMeshBuilder builder, Vector3 pos, Arc arcA, Arc arcB, UVArea area, bool invertFaces, bool invertNormalY, bool invertNormalXZ)
        {
        ...
        private void generateSidewalls(ROLMeshBuilder builder, UVArea caps)
        {
            int len = outerArcs.Count;
