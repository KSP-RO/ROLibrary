...
namespace ROLib
{
    ...
    public class UVArea
    {
        ...
        public UVArea(ConfigNode node)
        {
            ...
            this.u1 = node.ROLGetFloatValue("u1");
            this.u2 = node.ROLGetFloatValue("u2");
            this.v1 = node.ROLGetFloatValue("v1");
            this.v2 = node.ROLGetFloatValue("v2");
        }
    ...
    public class UVMap
    {
        ...
        public static UVMap GetUVMapGlobal(string name)
        {
            ...
            ConfigNode[] uvMapNodes = GameDatabase.Instance.GetConfigNodes("ROL_UVMAP");
            ConfigNode uvMapNode = Array.Find(uvMapNodes, m=>m.ROLGetStringValue("name") == name);
            UVMap map = null;
            if (uvMapNode != null)
            {
